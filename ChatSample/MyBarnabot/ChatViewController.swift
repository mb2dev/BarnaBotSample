...
class ChatViewController: JSQMessagesViewController, BBSessionDelegate {
    ...
    override func viewDidLoad() {
        ...
        self.senderDisplayName = _senderDisplayName()
        ...
        botBuilder
            ...
            .dialog(path: "/profile", [{(session : BBSession) -> Void in
                ...
                session.promptText("Hi! What is your name?")
                    ...
                    session.saveUserData(value : session.result, forKey: "name")
                    session.endDialog()
    ...
    override func didPressSend(_ button: UIButton, withMessageText text: String, senderId: String, senderDisplayName: String, date: Date) {
        ...
        self.messages.append(message!)
        self.finishSendingMessage(animated: true)
        botSession.receive(message!.text)
    ...
    func addMedia(_ media:JSQMediaItem) {
        let message = JSQMessage(senderId: self._senderId(), displayName: self._senderDisplayName(), media: media)
        self.messages.append(message!)
    ...
    func _senderId() -> String {
        return User.Wozniak.rawValue
    }
    
    func _senderDisplayName() -> String {
    ...
    override func collectionView(_ collectionView: JSQMessagesCollectionView, messageBubbleImageDataForItemAt indexPath: IndexPath) -> JSQMessageBubbleImageDataSource {
        ...
        return messages[indexPath.item].senderId == self._senderId() ? outgoingBubble : incomingBubble
    }
    ...
    override func collectionView(_ collectionView: JSQMessagesCollectionView, attributedTextForMessageBubbleTopLabelAt indexPath: IndexPath) -> NSAttributedString? {
        ...
        if message.senderId == self._senderId() {
            return nil
        }
    ...
    override func collectionView(_ collectionView: JSQMessagesCollectionView, layout collectionViewLayout: JSQMessagesCollectionViewFlowLayout, heightForMessageBubbleTopLabelAt indexPath: IndexPath) -> CGFloat {
        ...
        if currentMessage.senderId == self._senderId() {
            return 0.0
        }
